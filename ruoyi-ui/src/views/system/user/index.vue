    ...
    <el-row :gutter="20" >
      ...
      <el-col :span="20" :xs="24" style="width: 100%;">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <!-- <el-table-column label="角色" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" /> -->
          <el-table-column label="用户身份" align="center" key="roleName" prop="roleName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
